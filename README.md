...
> 当前里程碑:**M7 - 全部 MVP 业务功能已就绪(只剩 M9 部署/监控)**
...
| **M4** | 错题本 HTTP 接口 | ✅ 已完成 |
| **M5** | 书籍 + 章节(用户侧) | ✅ 已完成 |
| **M6** | 内容安全 + 合规中间件 | ✅ 已完成(微信 imgSecCheck/msgSecCheck + Mock) |
| **M7** | 管理员后台(API + Vue Web) | ✅ 已完成(后端 6 控制器 + 前端 6 页) |
| **M8** | 小程序前端 14 页 | ✅ 已完成 |
| M9 | 部署 / CI / 监控 / 上线清单 | ⏳ AI 同事 C |
